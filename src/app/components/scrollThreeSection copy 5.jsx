...
function ScrollThreeSection () {
  ...
  useEffect(() => {
    ...
    ScrollTrigger.refresh(); // Refresh for smooth animations
  ...
  ScrollTrigger.refresh(); // Refresh after setting up scroll triggers
    ...
    masterTL.add(lastPinTL).add(insidepinTL,'-=50')
  }, [])
...
<section className='flex justify-center items-center h-screen graybg'>
      ...
      <section ref={pinSectionRef} className='z-10 w-screen h-screen'>
        ...
        <div className='flex justify-center items-center w-screen h-screen text-white text-4xl'>
            <div
              ...
              ref={bigImgBackRef}
            >
              <div className='absolute h-screen bigImg' 
              // ref={bigImgRef}
              ></div>
      ...
      {/* scroll under */}
      <section className='bg-green-600 mt-[-150vh] w-screen h-screen' ref={insidePin}>
